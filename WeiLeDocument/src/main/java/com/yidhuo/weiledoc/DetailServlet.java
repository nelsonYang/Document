...
public class DetailServlet extends HttpServlet {
    private Collection<ServiceConfigBean> serviceConfigCollection;
    @Override
    public void init(){
           serviceConfigCollection = new DataGridBean().getServiceConfigMap().values();
    }
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (keyWords != null && !keyWords.isEmpty()) {
                ...
                Map<String, String> resultMap;
                for (ServiceConfigBean serviceConfigBean : serviceConfigCollection) {
                    resultMap = new HashMap<>(4, 1);
                    resultMap.put("actionName", serviceConfigBean.getAct());
                    resultMap.put("description", serviceConfigBean.getDescription());
                    resultMap.put("requestCrypt", serviceConfigBean.getRequestCrypt());
